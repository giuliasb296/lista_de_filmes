...
exports.Romance = exports.Acao = exports.BaseFilme = void 0;
var BaseFilme = /** @class */ (function () {
    function BaseFilme(titulo, ano, genero) {
        this.titulo = titulo;
        this.ano = ano;
        this.genero = genero;
    }
    BaseFilme.prototype.exibirDetalhes = function () {
        console.log("Titulo: ".concat(this.titulo, ", ano: ").concat(this.ano, ", genero: ").concat(this.genero));
    };
    return BaseFilme;
}());
exports.BaseFilme = BaseFilme;
